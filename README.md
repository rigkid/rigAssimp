...
Triangulates and bakes node transforms. Fills `texcoords` when present. Diffuse materials become `faceColors` when set. Skipped non-triangle meshes are reported in `IoResult::warning`.
